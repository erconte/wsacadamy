...
public class ExemploWhile {
	public static void main(String[] args) {
		...
		String email = JOptionPane.showInputDialog("Digite e-mail: ").toLowerCase();
			while (email.contains("@")==false || email.indexOf("@")<2) { // a sintaxe do while é a mesma do IF
		...
		//o nome não pode ter menos que 3 caracteres e mais que 20
		while (nome.length()<3 || nome.length()>20) {
			nome = JOptionPane.showInputDialog("Digite um nome válido: ").toLowerCase();
		}
